...
&hml LGUI A,       &hml LALT R,       &hml LCTRL S,      &hml_shift LSHFT T,      &kp G,             &kp M,             &hmr_shift LSHFT N,      &hmr LCTRL E,      &hmr LALT I,       &hmr LGUI O,       \
...
U_NP,              U_NP,              &kp ESC,           &kp TAB,           &kp SPACE,         &kp RET,           &kp BSPC,          U_LT(U_FUN, DEL),  U_NP,              U_NP
